                ...
                <form method="POST" action='/admin/portolio/{{$item->id}}'>
                    ...
                    <div class='flex-inputs flex100'>
						...
						<div class="input-element textarea">
                            ...
                            <textarea name="short_description" id="short_description" value='{{$item->short_description}}'>{{$item->short_description}}</textarea>
                        </div>
                        <div class="input-element textarea">
                            <label for="description">Descriere</label>
                            <textarea data-ownerid='{{$item->id}}' class='tinymce' name="description" id="description" value='{{$item->description}}'>{{$item->description}}</textarea>
                        </div>
